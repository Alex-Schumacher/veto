...
class _CommentScreenState extends State<CommentScreen> {
  ...
  var _comment = '';
  var dataBaseRefString = "posts";
  late CollectionReference databaseReference;
  ...
  void _trySubmit() {
    ...
    if (isValid) {
      ...
      if (databaseReference.path == "posts") {
        databaseReference
            .add({
        ...
        databaseReference.add({
          'billContent': _comment,
          'billName': "",
          'billPseudoCode': "",
          'dateTime': Timestamp.now(),
          'parentBillId': widget.parentPostId,
  ...
  Widget build(BuildContext context) {
    if (widget.isbill) {
      dataBaseRefString = "bills";
    }
    databaseReference =
        FirebaseFirestore.instance.collection(dataBaseRefString);
